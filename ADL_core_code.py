...
#ADL中用到了attention+擦除策略
#a copy from https://github.com/clovaai/wsolevaluation/blob/master/wsol/method/adl.py
class ADL(nn.Module):
...
if __name__ == '__main__':
    scoremaps = torch.randn((16,200,224,224))
    adl_test = ADL()
    result =  adl_test.forward(scoremaps)
    a = 2